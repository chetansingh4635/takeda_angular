...
@Component({
  selector: 'tm-sites-documents',
  templateUrl: './sites-documents.component.html',
  styleUrls: ['./sites-documents.component.css']
  // styleUrls: ['../../../content-management.css']
})
export class SitesDocumentsComponent implements OnInit {
  siteDocumentListData: any;
  ...
  selectValue: string = "Select Values"
  ...
  ngOnInit() {
    ...
    //   selectedFilters: ['Select Filter', Validators.required],
    // });
  ...
  public filterDocuments() {
    ...
    this.selectedValue = this.selectedValue.concat(this.langTypeValue).concat(this.docTypeValue).concat(this.siteTypeValue);
    // this.defaultSelectedValue = this.selectedValue.concat(['All Sites', 'All Languages']);
    console.log('filter values', this.selectedValue);
